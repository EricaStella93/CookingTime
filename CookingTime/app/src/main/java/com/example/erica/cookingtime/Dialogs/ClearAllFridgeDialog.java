...
public class ClearAllFridgeDialog extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        View layout = inflater.inflate(R.layout.clear_all_fridge_dialog, null);
        ...
        ImageButton imageButton = (ImageButton) layout.findViewById(R.id.fridge_exit_clear_all_dialog);
        ...
        Button clearAll = (Button) layout.findViewById(R.id.clear_all_fridge);
