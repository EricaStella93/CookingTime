...
public class AddIncludedIngrDialog extends DialogFragment {

    private AddInclIngredientDialogListener mListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mListener.onAddIngredient(name);
                dialog.dismiss();
            }
        });
    ...
    public void onAttach(Activity activity){
        ...
        try{
            mListener = (AddInclIngredientDialogListener) activity;
        }catch (ClassCastException e){
            Log.e("CLASSCAST", "MUST IMPLEMENT LISTENER");
        }
    }

    public interface AddInclIngredientDialogListener{
        void onAddIngredient(String name);
    }
}
